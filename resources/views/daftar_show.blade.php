                    ...
                    <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td> :
                                        @if ($daftar->status_daftar === 'baru')
                                            <span
                                                style="color: white;
                                    background-color: green; padding: 3px 8px; border-radius: 5px; display:
                                    inline-block;">
                        ...
                        <form action="/daftar/{{ $daftar->id }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                class="form-control" rows="3">{{ $daftar->diagnosis }}</textarea>
                                <span class="text-danger">{{ $errors->first('diagnosis') }}</span>
                            </div>
                            <div class="form-group mt-3">
                                <label for="tindakan">Tindakan</label>
                                <textarea name="tindakan" 
                                class="form-control" rows="3">{{ $daftar->tindakan }}</textarea>
